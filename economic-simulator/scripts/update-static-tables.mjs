...
const rlRaw = readCache("GOV_WGI_RL.EST");
const ccRaw = readCache("GOV_WGI_CC.EST");
const geRaw = readCache("GOV_WGI_GE.EST");
const pvRaw = readCache("GOV_WGI_PV.EST");
const rqRaw = readCache("GOV_WGI_RQ.EST");
const vaRaw = readCache("GOV_WGI_VA.EST");
