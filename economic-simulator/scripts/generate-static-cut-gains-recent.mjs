...
const thead = `<thead><tr style="color:rgba(255,255,255,0.5); font-size:0.82em;">
  ...
  <th style="text-align:right;padding:3px 8px"><span data-i18n="table.cutgains.avg-spending">Avg. spending %</span><br><span style="font-weight:normal;font-size:0.9em;opacity:0.7">${PERIOD_LABEL}</span></th>
  <th style="text-align:right;padding:3px 8px"><span data-i18n="table.cutgains.avg-growth">Avg. growth %</span><br><span style="font-weight:normal;font-size:0.9em;opacity:0.7">${PERIOD_LABEL}</span></th>
